...
func (o *orm) CreateJob(jb *Job, qopts ...pg.QOpt) error {
	...
	err := q.Transaction(func(tx pg.Queryer) error {
		...
		case VRF:
			var specID int32
			sql := `INSERT INTO vrf_specs (coordinator_address, public_key, min_incoming_confirmations, evm_chain_id, from_addresses, poll_period, requested_confs_delay, request_timeout, batch_coordinator_address, created_at, updated_at)
			VALUES (:coordinator_address, :public_key, :min_incoming_confirmations, :evm_chain_id, :from_addresses, :poll_period, :requested_confs_delay, :request_timeout, :batch_coordinator_address, NOW(), NOW())
			RETURNING id;`
